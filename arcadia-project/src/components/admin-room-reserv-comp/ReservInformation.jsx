...
export default function ReservInformation() {
    ...
    const [bookingData, setBookingData] = useState({
        ...
        name: "Alexander B. Corrine",
        college: "COECSA",
        department: "DCS",
        room: "ARC-1",
        date: "August 23",
        period: "11:00AM-12:00PM",
        purpose: "CS101 Group Study",
        ...
        <div className="bg-white overflow-hidden border border-grey mb-8 p-6 rounded-lg w-full">
            <div>
                <div className="flex justify-between items-center mb-4">
                    <h2 className="text-2xl font-semibold text-arcadia-black">
                        {showBookingForm ? 'Reservation Information' : 'Room Reservations'}
                    </h2>
                    <button 
                        className="resendCode"
                        onClick={() => setShowBookingForm(!showBookingForm)}
                    >
                        {showBookingForm ? 'Back to Reservations' : 'Go to Reservations'}
                    </button>
                </div>
                        ...
                        <div className="grid grid-cols-2 gap-x-16 gap-y-4">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center justify-between gap-4">
                                    ...
                                    <span className="px-3 py-1 rounded-full text-sm bg-dark-yellow text-dark-gray">
                                        {bookingData.status}
                                    </span>
                                </div>
                            </div>
