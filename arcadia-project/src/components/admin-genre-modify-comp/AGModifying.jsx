...
const AGModifying = ({ formData, setFormData }) => {
    ...
    const handleModify = async () => {
        ...
        const { genreID, ...updateData } = formData;
                ...
                <div className='flex'>
                    ...
                    <div className="w-full">
                        ...
                        <form className="space-y-2">
                            <div className="flex justify-between items-center" key="genreName">
                                ...
                                <input type="text" name="genreName" required
                                    ...
                                    style={validationErrors.genreName ? errorStyle : {}}
                                />
                            </div>
