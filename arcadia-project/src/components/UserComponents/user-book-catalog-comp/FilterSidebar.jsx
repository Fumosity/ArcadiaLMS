        ...
        <div className="w-64 p-4">
            <div className="space-y-6">
                ...
                <div className="space-y-2">
                    <div className="flex items-center space-x-2 px-3 py-0.5 border border-grey rounded-xl">
                    ...
                    <button className="w-full text-arcadia-red px-3 py-0.5 text-sm font-semibold text-left border border-grey rounded-xl hover:underline">
                        Clear Filters
                    </button>
                </div>

                {/* Publication Year Section */}
                <div className="px-3 py-3 border border-grey rounded-xl">
                    <PublicationYear />
                </div>
