    ...
    return (
        <div className="uHero-cont p-6 bg-white rounded-lg border border-grey">
            ...
            <textarea
                ...
                placeholder="Hello, I have noticed that the book cover of Robinson Crusoe is incorrect and shows the cover of The Great Gatsby. Thank you!"
                onKeyDown={(e) => e.preventDefault()}
            ></textarea>
