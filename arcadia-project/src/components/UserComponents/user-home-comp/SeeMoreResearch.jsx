...
const SeeMoreResearch = ({ selectedComponent, onBackClick, fetchResearch }) => {
  return (
    <div className="min-h-screen bg-light-white">
      <button
        onClick={onBackClick}
        className="w-[300px] h-[44px] mb-4 border border-grey rounded-xl px-5 inline-flex items-center gap-2 text-sm text-black hover:bg-light-gray transition-colors"
      >
