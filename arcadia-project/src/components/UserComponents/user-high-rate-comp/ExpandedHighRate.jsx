            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mt-6">
                {books.map((book, index) => (
                    <a
                        href="#"
                        key={index}
                        className="block bookCard-cont p-4 rounded-lg transition transform hover:shadow-lg hover:scale-105"
                    >
                        <img
                            src={book.img}
                            alt={book.title}
...
export default ExpandedHighRate;
