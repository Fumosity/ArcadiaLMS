    ...
    <div className="uMain-cont">
      <div className="flex w-full gap-4 p-4 border border-grey bg-silver rounded-lg shadow-sm">
        <div className="flex-1">
          ...
          <div className="text-md text-gray-700 mt-1 space-y-1">
            <p>
              <b>Authors:</b> {research.author.join(", ")}
            </p>
            <p>
              <b>Published:</b> {research.pubDate}
            </p>
            <span>
              <p>
          ...
          <p className="text-sm text-gray-600 mt-3 text-justify">{research.abstract || "No abstract available"}</p>
      ...
      <div className="mt-4 border-t border-grey p-2">
        ...
        <div className="h-100 p-2.5 flex justify-center items-center">
          {research.pdf ? (
            <div
              className="p-2.5 pdf-viewer flex justify-center border border-grey rounded-lg"
              style={{ height: "725px" }}
            >
              {isLoading && (
