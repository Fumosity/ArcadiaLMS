...
const FileATix = () => {
    return (
        <div className="uHero-cont p-6 bg-white rounded-lg border border-grey">
            ...
            In addition to the contents above, your account information will also be included when filing a ticket. By pressing the button below, you hereby agree 
            that everything that you have written above is factual and current, and that the abuse of this function may result in disciplinary action against your 
            account.
            </p>
