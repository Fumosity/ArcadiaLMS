...
const SupportTixStatus = () => {
    const reportData = [
        { type: "Account", status: "Ongoing", subject: "Bugs on the Home Page", date: "Sept. 21, 2024", time: "12:42:12PM", reportID: "456" },
    ...
    return (
        <div className="uHero-cont p-6 bg-white rounded-lg border border-grey">
            ...
            <h2 className="text-lg font-semibold mb-4">Support Ticket Status</h2>
