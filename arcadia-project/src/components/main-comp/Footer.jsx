...
const Footer = () => (
    <footer className="bg-light-gray mt-12 py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-7 gap-8">
            ...
            <div>
                <h4 className="text-sm font-semibold mb-4">Circulation</h4>
                <ul className="text-sm text-gray-600 space-y-2">
                    <li>Book Checking</li>
                    <li>History</li>
            ...
            <div>
                <h4 className="text-sm font-semibold mb-4">Book Management</h4>
                <ul className="text-sm text-gray-600 space-y-2">
                    <li>Inventory</li>
                    <li>Add Books</li>
                    <li>Remove Books</li>
            ...
            <div>
                <h4 className="text-sm font-semibold mb-4">Research Management</h4>
                <ul className="text-sm text-gray-600 space-y-2">
                    <li>Inventory</li>
                    <li>Add Theses</li>
                    <li>Remove Theses</li>
            ...
            <div>
                <h4 className="text-sm font-semibold mb-4">User Accounts</h4>
                <ul className="text-sm text-gray-600 space-y-2">
                    <li>Accounts List</li>
                    <li>Library Cards</li>
            ...
            <div>
                <h4 className="text-sm font-semibold mb-4">Reservations</h4>
                <ul className="text-sm text-gray-600 space-y-2">
