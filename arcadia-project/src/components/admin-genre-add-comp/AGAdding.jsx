...
const AGAdding = ({ formData, setFormData }) => {
  ...
  const handleCategoryChange = (category) => {
    ...
    setValidationErrors((prevErrors) => ({ ...prevErrors, category: false }))
  }
  ...
  const handleSubmit = async () => {
    ...
    const requiredFields = ["genre", "category", "description", "img"]
    ...
    try {
      const success = await addGenre(formData)
              ...
              <div className="w-full h-fit flex justify-center">
                ...
                >
                  <img
                    ...
                    style={validationErrors.img ? errorStyle : {}}
                  />
                </div>
              </div>
                ...
                <div className="flex gap-4 w-2/3">
                  {["Fiction", "Non-fiction"].map((category) => (
                    <button
                      ...
                      style={validationErrors.category && !categoryFilter ? errorStyle : {}}
                    >
                      {category}
                    </button>
                  ))}
