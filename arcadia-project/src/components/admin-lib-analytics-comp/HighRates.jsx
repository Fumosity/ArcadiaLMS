...
const HighRates = () => {
    ...
    const fetchHighlyRated = async () => {
        try {
            ...
            let books = booksWithDetails.sort((a, b) => b.avgRating - a.avgRating).slice(0, 10)
    ...
    useEffect(() => {
        ...
        console.log("highest rated", books)
    ...
    return (
        <div className="bg-white border border-grey p-4 rounded-lg w-full">
            <h3 className="text-2xl font-semibold mb-4">Highest Rated</h3>
