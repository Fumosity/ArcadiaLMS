...
const UserInformations = () => {
  ...
  return (
    <div className="bg-white p-4 rounded-lg border-grey border">
      <h3 className="text-2xl font-semibold mb-4">User Account Information</h3>
      <div className="flex flex-col items-center mb-4">
        ...
        <h2 className="text-xl font-medium text-arcadia-black">{user.userFName || ""} {user.userLName || ""}</h2>
      </div>
