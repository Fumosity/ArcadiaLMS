...
const CnfrmBlacklist = ({ isOpen, onClose, onBlacklist, accountName }) => {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg w-full max-w-md p-6 shadow-xl relative">
        ...
        <p className="text-gray-700 mb-6">
          You are about to add {accountName || "[Account Name]"} into the blacklist. 
          This will result in their reduced access to the system. 
