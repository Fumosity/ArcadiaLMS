...
const WrngDemote = ({ isOpen, onClose, onDemote }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-xl w-full max-w-md p-6 shadow-xl relative">
        ...
        You are about to turn [Account Name] into a regular user account. 
        This will result in the loss of full access to the system. 
