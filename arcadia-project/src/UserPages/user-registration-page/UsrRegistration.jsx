...
const UsrRegistration = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Use the API_URL to ensure we're hitting the correct endpoint
      ...
      <section className="flex gap-5 justify-center w-full max-md:max-w-full">
        <div className="flex overflow-hidden flex-col justify-between items-center min-w-[240px] w-[500px]">
          <form
            ...
            className="flex overflow-hidden flex-col px-6 py-12 w-full rounded-3xl border border-solid bg-neutral-50 border-zinc-300 max-w-[500px] max-md:px-5 max-md:max-w-full"
          >
            ...
            <div className="flex overflow-hidden flex-col w-full max-md:max-w-full">
              <label
                ...
                className="overflow-hidden gap-2.5 self-stretch w-full max-md:max-w-full"
              >
                Confirm Password:
              </label>
              <input
