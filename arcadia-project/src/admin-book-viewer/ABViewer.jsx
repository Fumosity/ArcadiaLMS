  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="flex items-center mb-6">
        ...
        <h2 className="text-2xl font-semibold">Book Viewer for Admin1</h2>
        <h2 className="text-2xl font-semibold">Book Viewer for Admin2</h2>
        <h2 className="text-2xl font-semibold">Book Viewer for Admin3</h2>
        <h2 className="text-2xl font-semibold">Book Viewer for Admin4</h2>
        <h2 className="text-2xl font-semibold">Book Viewer for Admin5</h2>
      </div>
